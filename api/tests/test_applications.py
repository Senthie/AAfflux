...
from app.schemas.application import APIKeyCreate, ApplicationCreate, ApplicationUpdate
...
class TestApplications:
    ...
    async def test_application_workflow_association(
        self, application_service: ApplicationService, test_workflow: Workflow, test_user: User
    ):
        """测试应用与工作流关联"""
    ...
    async def test_application_status_management(
        self, application_service: ApplicationService, test_workflow: Workflow, test_user: User
    ):
        """测试应用状态管理"""
        app_data = ApplicationCreate(
