...
Date: 2025-12-23 15:28:17
LastEditors: Senthie seemoon2077@gmail.com
LastEditTime: 2025-12-23 15:28:43
FilePath: /api/app/engine/nodes/agent/exc.py
Description: Agent 节点执行时候的错误
...
class AgentStrategyError(AgentNodeError):
    ...
    def __init__(
        self, message: str, strategy_name: str | None = None, provider_name: str | None = None
    ):
